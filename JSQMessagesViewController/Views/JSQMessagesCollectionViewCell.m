...
- (void)awakeFromNib
{
    ...
    [self.messageBubbleContainerView addObserver:self forKeyPath: @"alpha" options: NSKeyValueObservingOptionNew context: nil];
}
...
- (void)dealloc
{
    ...
    [self.messageBubbleContainerView removeObserver:self forKeyPath:@"alpha"];
}
